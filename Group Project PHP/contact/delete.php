...
<td class="contact-delete">
     ...
     <input type="text" placeholder="Enter Student Number" name="s_number" id="telephone_input" maxlength="20" required>
      <input type="submit" value="Delete" id="form_button" name="submit_d"/>
...
$Student_num = $_POST['s_number'];  
$delete_query = "DELETE FROM students WHERE Student_number = $Student_num";
